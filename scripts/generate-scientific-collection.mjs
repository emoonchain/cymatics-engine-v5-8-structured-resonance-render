...
function parseArgs(argv) {
  const args = {
    count: 1000,
    start: 1,
    seed: "resonance-genesis-scientific-v1",
...
function printHelp() {
  console.log(`
Generate scientific Chladni Node NFT collection.
...
Options:
  ...
  --resolution <n>         Scientific render resolution. Default: 460
`);
}
...
function makeMetadata({
  ...
  const metadata = {
    ...
    description:
      "A scientific Chladni Node from the Resonance Genesis collection. Generated from deterministic eigenmode-inspired plate resonance math, nodal line detection, and on-chain mining traits.",
    image: imageUri,
    ...
    hashratePreview,
    renderer: "scientific-chladni-node-v1",
    ...
    attributes: [
      ...
      { trait_type: "Visual Style", value: "Scientific Chladni" },
    ],
  };
...
function main() {
  ...
  console.log("Generating Resonance Genesis scientific Chladni collection...");
  ...
  console.log("");
  console.log("Scientific collection generated.");
